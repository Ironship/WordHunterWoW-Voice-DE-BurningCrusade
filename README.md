# QuestWordHunter — German Voiceover: The Burning Crusade

The German a quest giver says out loud, for The Burning Crusade: quest ids
**9,666–11,579**.

**14,719 clips, 18.6 hours.** Both are counted from this pack's own duration
...
`sounds/` is committed, and `.gitignore` says why. It is 346 MB here, out of
...
```
python Tools/build_pack.py --only BurningCrusade --out "…/Interface/AddOns"
```
